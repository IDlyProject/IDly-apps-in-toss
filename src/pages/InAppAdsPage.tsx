        ...
        <ListRow
          ...
          right={
            <Button
              size="small"
              variant="weak"
              disabled={!interstitial.isSupported || !interstitial.isAdLoaded}
              loading={interstitial.isSupported && !interstitial.isAdLoaded}
        ...
        <ListRow
          ...
          right={
            <Button
              size="small"
              variant="weak"
              disabled={!rewarded.isSupported || !rewarded.isAdLoaded}
              loading={rewarded.isSupported && !rewarded.isAdLoaded}
